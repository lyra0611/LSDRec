...
import setproctitle
setproctitle.setproctitle("LSDRec")
...
def get_args():
    ...
    parser.add_argument('--desc', type=str, default='LSDRec', help='Experiment Description.')
    parser.add_argument('--model', '-m', type=str, default='LSDRec', help='Model for session-based rec.')
    ...
    parser.add_argument('--cl_l', type=float, default=0.5)   
    parser.add_argument('--graphcl_coefficient', type=float, default=1)   
    parser.add_argument('--cl_temp', type=float, default=0.8)   
...
if __name__ == '__main__':
    ...
    config_dict = {
        ...
        "graphcl_coefficient":args.graphcl_coefficient,
    ...
    if args.dataset == "reddit":
        ...
        config_dict["learning_rate"] = 0.002
        config_dict["graphcl_coefficient"] = 1
        config_dict["cl_l"] = 0.1

    elif args.dataset == "beauty" or args.dataset == "sports" or args.dataset == "ml-1m":
        #config_dict["graphcl_coefficient"] = 0.3
        ...
        if args.dataset == "beauty":
            ...
            config_dict["graphcl_coefficient"] = 0.4
            config_dict["train_batch_size"] = 512
            config_dict["cl_l"] = 0.5
